...
| GET | `/api/v1/timeline/logs/drone?eqpId=...` | Drone 로그 |
...
- 일부 Drone 관련 로그는 기본 DB를 함께 사용할 수 있습니다.
...
```http
GET /api/v1/timeline/logs/eqp?eqpId=EQP-001&from=2026-01-01&to=2026-01-31&limit=1000
```
