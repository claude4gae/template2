...
class CtProcessCommentStructureTests(SimpleTestCase):
    ...
    def test_write_selected_deflate_csv_filters_use_yn_and_create_date(self) -> None:
        """USE_YN=N 행과 CREATE_DATE 기준 기간 밖 행을 제외합니다."""
        ...
        with TemporaryDirectory() as temp_dir:
            ...
            _write_deflate_csv(
                ...
                [
                    ...
                    _build_comment_row(workorder_id="WO3", use_yn="Y", create_date="2000-01-01 00:00:00"),
                ],
            )
            ...
            self.assertTrue(selected.read_text(encoding="utf-8").startswith("WO1,L1,PROC"))
